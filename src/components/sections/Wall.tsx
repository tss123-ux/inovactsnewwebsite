...
const Wall = () => {
  ...
  return (
    <motion.div
      className="lg:my-20 py-16 flex flex-col items-center justify-center px-4 lg:px-8 mx-auto max-w-7xl relative bg-gradient-to-b from-transparent via-blue-50/30 to-transparent"
      initial="hidden"
      animate="visible"
